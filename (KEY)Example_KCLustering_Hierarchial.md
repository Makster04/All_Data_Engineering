...
| **Flexibility**          | Less flexible, because **k** is fixed.<br>**Example:** Changing the number of groups requires starting again from scratch. | More flexible; easily choose different groupings after clustering.<br>**Example:** Picking different cluster numbers from one dendrogram without redoing the whole analysis. |
